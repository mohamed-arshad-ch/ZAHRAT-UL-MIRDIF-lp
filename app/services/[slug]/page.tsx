...
import { ChevronRight, Check, FileText, Briefcase, Shield, Building, Users, Award } from "lucide-react"
        ...
        <div className="container relative z-10 mx-auto px-4" ref={heroRef}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                <Link
                  href={`https://wa.me/971543412392?text=Hello, I'm interested in your ${service.shortTitle} services. Can you provide more information?`}
                  target="_blank"
        ...
        <div className="container relative z-10 mx-auto px-4" ref={heroRef}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                <Link
                  href={`https://wa.me/971501234567?text=Hello, I'm interested in your ${service.shortTitle} services. Can you provide more information?`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#128C7E] text-white rounded-full py-3 px-6 transition-all duration-300 hover:shadow-lg"
                >
                ...
                >
                  ...
                  >
                    <div className="w-12 h-12 rounded-full bg-[#2363eb]/10 group-hover:bg-[#2363eb] flex items-center justify-center mb-4 transition-colors duration-300">
                      ...
                      {relatedService.id === "it-hr-services" && (
                        <Users className="h-5 w-5 text-[#2363eb] group-hover:text-white transition-colors duration-300" />
                      )}
                      {relatedService.id === "golden-visa" && (
                        <Award className="h-5 w-5 text-[#2363eb] group-hover:text-white transition-colors duration-300" />
                      )}
